...
% Frontespizio
%**************************************************************
\newcommand{\myName}{Nome Cognome}                                    % autore
\newcommand{\myTitle}{Una tesi bellissima}
\newcommand{\mySupervisor}{Nome Cognome}                        % relatore
...
\newenvironment{usecase}[2]{
    \renewcommand{\theusecasecounter}{\usecasename #1}  % this is where the
%display of
                                                        % the counter is
